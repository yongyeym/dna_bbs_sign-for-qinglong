...
NGA_COOKIE, NGA_UID, NGA_CLIENT_CHECKSUM = util.get_config_env("nga_cookie", "nga_uid", "nga_client_checksum") if USE_LOCAL_COOKIE else util.get_os_env("nga_cookie", "nga_uid", "nga_client_checksum")
